            ...
            <div className="mx-auto max-w-lg px-4">
                ...
                <form onSubmit={handleSubmit} className="mb-6 flex gap-2">
                    ...
                    <button
                        type="submit"
                        disabled={processing}
                        className="rounded-lg bg-blue-600 px-5 py-2 font-semibold text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:opacity-50"
                    >
                        Add
                    </button>
                </form>
